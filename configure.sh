...
CONFIG_DISABLE_BINDINGS=${OPT_DISABLE_BINDINGS}
...
CONFIG_SPT_TENDER_LIBSECCOMP_LDLIBS=${CONFIG_SPT_TENDER_LIBSECCOMP_LDFLAGS}
EOM
...
CONFIG_HOST_ARCH=${CONFIG_HOST_ARCH}
CONFIG_HOST=${CONFIG_HOST}
CONFIG_HOST_DARWIN=$(if [ "${CONFIG_HOST}" = "darwin" ]; then echo 1; else echo; fi)
CONFIG_HOST_CC=${HOST_CC}
CONFIG_HOST_AR=${HOST_AR}
...
CONFIG_TARGET_CC_IS_OPENBSD=${CONFIG_TARGET_CC_IS_OPENBSD}
